...
public class Merging {
	...
	Node MergeLists(Node list1, Node list2) {
		 ...
		 * 
		 * Node head; if (list1.data < list2.data) { head = list1; } else { head
		 * = list2; list2 = list1; list1 = head; } while (list1.next != null &&
		 * list2 != null) { if (list1.next.data <= list2.data) { list1 =
		 * list1.next; } else { Node tmp = list1.next; list1.next = list2; list2
		 * = tmp; } } if (list1.next == null) list1.next = list2; return head;
		 */
		if (list1 == null)
			return list2;
		if (list2 == null)
